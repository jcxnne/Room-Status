...
// Fetch notifications for students (excluding deleted ones)
$sql = "SELECT n.*, 
        CASE 
        ...
        LEFT JOIN notification_deletes nd ON n.id = nd.notification_id
            AND nd.user_id = ? AND nd.user_type = 'student'
        WHERE n.target_role IN ('all', 'student')
        AND nd.id IS NULL
  ...
  <div class="sidebar">
    ...
    <div class="profile">
      ...
      <div class="profile-info">
        ...
        <p><?php echo htmlspecialchars($email); ?><br>Student</p>
      </div>
    </div>
    ...
    <div class="nav-links nav-top">
      ...
      <a href="snotification.php" class="active">
