...
if ($section_id > 0) {
    ...
    if ($selected_section) {
        // Fetch schedules for this section - Auto-updated when admin makes changes!
        $sql = "SELECT s.*, 
                subj.subject_code, subj.subject_name, subj.units,
                CONCAT(i.first_name, ' ', i.last_name) as instructor_name,
                r.room_number, r.room_name, r.building,
...
<body>
  ...
  <div class="sidebar">
    ...
    <div class="nav-links nav-top">
      ...
      <a href="fschedule.php" class="active">
    ...
    <?php if ($selected_section): ?>
      ...
      <div class="schedule-view">
        ...
        <div class="refresh-notice">
          ...
          <span>This schedule syncs with admin updates in real-time. Refresh anytime to see the latest changes.</span>
        ...
        <div class="schedule-header">
          ...
          <div class="schedule-actions">
            ...
            <a href="fschedule.php" class="back-to-sections">
        ...
        <?php else: ?>
          <table class="schedule-table" id="scheduleTable">
            ...
            <tbody>
              <?php 
              $facultyFullName = $user['first_name'] . ' ' . $user['last_name'];
              foreach ($schedules as $schedule): 
                $isMyClass = ($schedule['instructor_name'] === $facultyFullName);
              ?>
                <tr data-schedule-id="<?php echo $schedule['id']; ?>" <?php echo $isMyClass ? 'style="background-color: #fffde7;"' : ''; ?>>
                  ...
                  <td>
                    ...
                    <?php if ($isMyClass): ?>
                      <span class="faculty-indicator">YOUR CLASS</span>
                    <?php endif; ?>
                  </td>
                  <td>
                    <div class="room-info">
        ...
        <div class="schedule-buttons">
          <?php foreach ($sections as $section): ?>
            <button class="<?php echo strtolower($section['program']); ?>" 
                    ...
                    onclick="window.location.href='fschedule.php?section_id=<?php echo $section['id']; ?>'">
  ...
  <script>
    ...
    // Faculty information
    const facultyName = "<?php echo addslashes($user['first_name'] . ' ' . $user['last_name']); ?>";
    ...
    async function refreshSchedule() {
      ...
      try {
        const response = await fetch(`fschedule.php?ajax=refresh&section_id=${sectionId}`);
    ...
    function updateScheduleTable(schedules) {
      ...
      tbody.innerHTML = schedules.map(schedule => {
        const isMyClass = schedule.instructor_name === facultyName;
        return `
          <tr data-schedule-id="${schedule.id}" class="schedule-updated" ${isMyClass ? 'style="background-color: #fffde7;"' : ''}>
            ...
            <td>
              ${escapeHtml(schedule.instructor_name)}
              ${isMyClass ? '<span class="faculty-indicator">YOUR CLASS</span>' : ''}
            </td>
            <td>
              <div class="room-info">
