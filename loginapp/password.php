...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $current_password = trim($_POST['current_password']); // Remove spaces
    $new_password = $_POST['new_password'];
    $confirm_password = $_POST['confirm_password'];
    
    // DEBUG: Check what's in the database
    $debug_info .= "User ID: " . $user_id . "<br>";
    $debug_info .= "Password field exists: " . (isset($user['password']) ? 'Yes' : 'No') . "<br>";
    if (isset($user['password'])) {
        $debug_info .= "Password hash length: " . strlen($user['password']) . "<br>";
        $debug_info .= "Hash starts with: " . substr($user['password'], 0, 20) . "...<br>";
        $debug_info .= "Current password length: " . strlen($current_password) . "<br>";
    }
    ...
    if (empty($current_password) || empty($new_password) || empty($confirm_password)) {
        ...
        elseif (strlen($user['password']) < 50) {
            ...
            $debug_info .= "Database password appears to be plain text<br>";
        }
        ...
        elseif (password_verify($current_password, $user['password'])) {
            ...
            $debug_info .= "password_verify() returned false<br>";
            
            // Additional check: compare with plain text (ONLY FOR DEBUGGING)
            if ($current_password === $user['password']) {
                $debug_info .= "<strong>WARNING: Password appears to be stored in PLAIN TEXT!</strong><br>";
                $debug_info .= "You need to re-hash all passwords in the database.<br>";
            }
        }
    }
}
      ...
      <div class="profile-card">
        <div class="profile-sidebar">
          ...
          <div class="profile-nav">
            <a href="sprofile.php" class="profile-nav-item">
              <i data-lucide="user"></i>
              <span>Personal Information</span>
            </a>
            <a href="password.php" class="profile-nav-item active">
